...
function newReplayLayer()
{
    ...
    {
        cc.log("玩家胡牌 ed.eatWhat" + ed.eatWhat);
        ...
        //
        //if(IsMyTurn() && sData.tData.tState == TableState.waitPut && pl.mjState == TableState.waitPut)
        //{
        //    imgName = "mj_" + pl.mjhand[pl.mjhand.length - 1] + ".png";
        //}
